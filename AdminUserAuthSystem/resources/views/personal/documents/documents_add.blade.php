          ...
          @foreach ($files as $rs)
            <tr class="text-xs bg-gray-50">
              ...
              <td>
                ...
                <a class="inline-block mr-2" href="{{ route('personal.personal_documents_approve',['applications_id' =>$data->id]) }}" onclick="return confirm('Onayla ! onaylamak ister misiniz?')">
