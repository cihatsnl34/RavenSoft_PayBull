              ...
              <table class="table-auto w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="p-0">
                      <div class="flex items-center justify-center p-5 h-20 text-center bg-white rounded-tr-5xl rounded-br-5xl">
                        <img src="{{asset('assets')}}/admin/uinel-assets/elements/dashboard-tables/checkmark.svg" alt="">
                      </div>
                    </td>
                  </tr>
                  <tr>
      ...
      <div class="md:grid md:grid-cols-2 md:items-center">
        ...
        <div class="relative pt-24 pb-12 md:pb-24 px-6 2xl:pt-44 2xl:pb-52 bg-blueGray-100 rounded-b-10xl">
          <div class="relative max-w-lg mx-auto">
            <img class="absolute top-1/2 transform -translate-y-1/2" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/bg-form.svg" alt="">
    ...
    <section class="py-8 bg-blueGray-50">
      <div class="container px-4 mx-auto">
        <div class="relative p-10 md:py-20 xl:px-20 bg-white overflow-hidden rounded-3xl">
          <img class="absolute -right-16 top-1/2 transform -translate-y-1/2" src="{{asset('assets')}}/admin/uinel-assets/images/dashboard-banners/header5.png" alt="">
