    <section class="py-8 bg-blueGray-50"><div class="container px-4 mx-auto">
        ...
        <div class="p-7 pb-16 pt-12 bg-white rounded-5xl">
          ...
          <div class="overflow-x-auto">
            <div class="inline-block min-w-full overflow-hidden">
              <table class="table-auto w-full"><thead><tr><th class="flex items-center pl-9 h-20 bg-white text-left">
                      ...
                      <div>
                        <svg class="my-1" width="7" height="4" viewbox="0 0 7 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.898704 3.84541C0.692525 4.05153 0.359292 4.05153 0.154634 3.84541C-0.0507836 3.6393 -0.0523052 3.30629 0.154635 3.10017L3.12787 0.154586C3.33329 -0.0515278 3.66576 -0.0515278 3.8727 0.154586L6.84594 3.10017C7.05135 3.30552 7.05135 3.6393 6.84594 3.84541C6.63976 4.05153 6.30652 4.05153 6.10187 3.84541L3.49915 1.42973L0.898704 3.84541Z" fill="#9E9FA0"></path></svg><svg class="my-1" width="7" height="4" viewbox="0 0 7 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.10129 0.154586C6.30747 -0.0515286 6.64071 -0.0515286 6.84537 0.154586C7.05078 0.3607 7.0523 0.693713 6.84537 0.899827L3.87213 3.84541C3.66671 4.05153 3.33424 4.05153 3.1273 3.84541L0.154064 0.899827C-0.0513545 0.694482 -0.0513545 0.3607 0.154064 0.154586C0.360242 -0.0515286 0.693476 -0.0515286 0.898133 0.154586L3.50085 2.57027L6.10129 0.154586Z" fill="#9E9FA0"></path></svg></div>
                    </th>
                  ...
                  </tr></thead><tbody><tr><td class="p-0">
                    ...
                    <td class="p-0">
                      <div class="flex items-center justify-center p-5 h-20 text-center bg-white rounded-tr-5xl rounded-br-5xl">
                        <img src="{{asset('assets')}}/admin/uinel-assets/elements/dashboard-tables/checkmark.svg" alt=""></div>
                    </td>
                  </tr><tr><td class="p-0">
                      <div class="flex items-center pl-9 h-20 bg-blueGray-50 border-l border-t border-b border-gray-100 rounded-tl-5xl rounded-bl-5xl">
    ...
    <section class="font-medium bg-white"><div class="md:grid md:grid-cols-2 md:items-center">
        <div class="container mx-auto max-w-xl px-4 lg:pr-0 py-24 md:py-0">
          ...
          <ul><li class="flex leading-6 font-normal text-darkBlueGray-400 mb-3">
              <img class="mr-6" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/checked.svg" alt=""><span>Müşteriye Oto mail gider</span>
            </li>
            <li class="flex leading-6 font-normal text-darkBlueGray-400 mb-3">
              <img class="mr-6" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/checked.svg" alt=""><span>Evrak yükleme talebi oluşur</span>
            </li>
            <li class="flex leading-6 font-normal text-darkBlueGray-400">
              <img class="mr-6" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/checked.svg" alt=""><span>Durum ekranını görebilirsiniz</span>
            </li>
          </ul></div>
        <div class="relative pt-24 pb-12 md:pb-24 px-6 2xl:pt-44 2xl:pb-52 bg-blueGray-100 rounded-b-10xl">
          <div class="relative max-w-lg mx-auto">
            <img class="absolute top-1/2 transform -translate-y-1/2" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/bg-form.svg" alt=""><div class="bg-white rounded-3xl py-16 md:py-24 px-8 lg:px-16 m-5 relative z-10">
              ...
              <div class="relative md:mb-12">
                <img class="z-10 absolute top-1/2 transform -translate-y-1/2 left-8" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/mail.svg" alt=""><input class="bg-blueGray-50 rounded-2xl h-16 text-darkBlueGray-400 w-full text-lg px-8 pl-16 border border-blue-500 outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" type="text"></div>
          ...
          <a href="#">
            <img class="absolute w-20 transform -translate-x-1/2 xl:w-auto left-1/2 md:left-0 top-0 md:top-20 xl:top-1/2 -translate-y-1/2" src="{{asset('assets')}}/admin/uinel-assets/elements/newsletter/scroll-down.svg" alt=""></a>
        </div>
      </div>
    </section>
    ...
    <section class="py-8 bg-blueGray-50"><div class="container px-4 mx-auto">
        <div class="relative p-10 md:py-20 xl:px-20 bg-white overflow-hidden rounded-3xl">
          <img class="absolute -right-16 top-1/2 transform -translate-y-1/2" src="{{asset('assets')}}/admin/uinel-assets/images/dashboard-banners/header5.png" alt=""><div class="relative z-10">
        ...
        <div class="flex flex-wrap -mx-2">
          <div class="w-full md:w-1/3 lg:w-1/6 px-2 mb-4 lg:mb-0">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/docusign.png" alt="">
            </div>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/6 px-2 mb-4 lg:mb-0">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/british-business-bank.png" alt="">
            </div>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/6 px-2 mb-4 lg:mb-0">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/fedex.png" alt="">
            </div>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/6 px-2 mb-4 md:mb-0">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/starling-bank.png" alt="">
            </div>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/6 px-2 mb-4 md:mb-0">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/zendesk.png" alt="">
            </div>
          </div>
          <div class="w-full md:w-1/3 lg:w-1/6 px-2">
            <div class="flex items-center justify-center h-28 px-4 border border-gray-100 rounded-5xl">
              <img class="h-10" src="{{asset('assets')}}/admin/uinel-assets/brands/aol.svg" alt="">
            </div>
          </div>
        </div>
      </div>
