        ...
        <table class="table-auto w-full">
          <thead>
            <tr class="text-xs text-gray-500 text-left">
              ...
              <th class="pb-3 font-medium">Send mail</th>
          ...
          <tbody>
            ...
            <tr class="text-xs bg-gray-50">
              ...
              <td class="font-medium">
                <center>
                <a class="inline-block mr-2" href="{{ route('admin.admin_application_approve',['id' =>$rs->id]) }}" onclick="return confirm('Onayla ! onaylamak ister misiniz?')">
              ...
              <td>
                ...
                <a class="inline-block" href="{{route('admin.admin_application_delete',['id' =>$rs->id])}}" onclick="return confirm('Delete ! Are you sure ?')">
