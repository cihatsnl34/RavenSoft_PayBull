...
<main>
    <section class="discover">
        <div class="container">
            <div class="section-span text-center">PAYBULL UYGULAMALAR DÜNYASI</div>
            <h2 class="section-title text-center">
                Entegrasyonlara göz atın!
            </h2>
            <p class="section-text text-center">
                Paybull ile dünyanın her yerinden kolayca ödeme alın; taksitli satışlar yapın.
                Siz işlerinize odaklanırken ödemelerinizi bize bırakın.
            </p>
            <div class="integrations_search">
                <input type="text" placeholder="Entegrasyonlarda arayın.." />
            </div>
        </div>
    </section>
    <section class="integrations_list">
        <div class="container">
            <div class="row gx-md-4 gy-sm-3 gx-0 gy-md-4 gy-sm-3 gy-3">
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        <div class="integrations_item-title row align-items-center">
                            <div class="col-auto">
                                <div class="icon primary"><span><img src="{{asset('assets')}}/frontEnd/img/magento-icon.svg" alt="" /></span>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <p class="integrations_item-desc">
                            Aşağıda bulunan sürüm sekmesinden versiyonunuzu seçip indirin ve anında kolay
                            entegrasyona başlayın!

                        </p>
                        <div class="integrations_item-select">
                            <select name="" class="selectric-select selectsec " id="magento-version">
                                <option value="">İndirmek için sürüm seçiniz</option>
                                <option value="https://docs.paybull.com/paybull_magento1x.zip">v1.x</option>
                                <option value="https://docs.paybull.com/paybull_magento2x.zip">v2.x</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a onclick="selectLink('magento-version')">Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        <div class="integrations_item-title row align-items-center">
                            <div class="col-auto">
                                <div class="icon secondary"><span><img src="{{asset('assets')}}/frontEnd/img/wordpress-icon.svg" alt="" /></span>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="integrations_item-select white-hover">
                            <select name="" class="selectric-select selectsec  " id="wordpress-version">
                                <option value="">İndirmek için sürüm seçiniz</option>
                                <option value="https://docs.paybull.com/paybull_woocommerce5.8x.zip" >v5.8x</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a onclick="selectLink('wordpress-version')" >Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        <div class="integrations_item-title row align-items-center">
                            <div class="col-auto">
                                <div class="icon fourth"><span><img width="30px" height="30px" src="{{asset('assets')}}/frontEnd/img/prestashop-icon.png" alt="" /></span></div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="integrations_item-select white-hover">
                            <select name="" class="selectric-select selectsec " id="presta-version">
                                <option value="">İndirmek için sürüm seçiniz</option>
                                <option value="https://docs.paybull.com/paybull_prestashop1.6x.zip">v1.6x</option>
                                <option value="https://docs.paybull.com/paybull_prestashop1.7x.zip">v1.7x</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a onclick="selectLink('presta-version')" >Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        <div class="integrations_item-title row align-items-center">
                            <div class="col-auto">
                                <div class="icon fourth"><span><img src="{{asset('assets')}}/frontEnd/img/whmcs-icon.png" alt="" /></span></div>
                            </div>
                            <div class="col-auto">
                                <div class="title">WHMCS</div>
                            </div>
                        </div>
                        <p class="integrations_item-desc">
                            Aşağıda bulunan sürüm sekmesinden versiyonunuzu seçip indirin ve anında kolay
                        ...
                        <div class="integrations_item-select white-hover">
                            <select name="" class="selectric-select selectsec " id="whmcs-version">
                                <option value="">İndirmek için sürüm seçiniz</option>
                                <option value="https://docs.paybull.com/paybull_whmcs.zip">v1.0.0</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a onclick="selectLink('whmcs-version')">Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        <div class="integrations_item-title row align-items-center">
                            <div class="col-auto">
                                <div class="icon fifth"><span><img src="{{asset('assets')}}/frontEnd/img/nopcommerce-icon.svg" alt="" /></span>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="integrations_item-select white-hover">
                            <select name="" class="selectric-select selectsec " id="nicer-select-id">
                                <option>İndirmek için sürüm seçiniz</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a>Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="integrations_item">
                        ...
                        <div class="integrations_item-select">
                            <select name="" class="selectric-select selectsec " id="opencart-version">
                                <option value="">İndirmek için sürüm seçiniz</option>
                                <option value="https://docs.paybull.com/paybull_opencart2x.ocmod.zip">v2.x</option>
                                <option value="https://docs.paybull.com/paybull_opencart3x.ocmod.zip">v3.x</option>
                            </select>
                        </div>
                        <div class="integrations_item-button mt-2 white-hover">
                            <a onclick="selectLink('opencart-version')">Entegrasyonu İndir</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-0 align-items-center">
                            <div class="col-xl-5 col-12">
                                ...
                                <p class="slide-text mb-4">
                                    PayBull Sanal POS ile bankalarla tek tek anlaşmanıza gerek kalmadan, en uygun
                                    komisyon oranlarıyla 24 saat içinde ödeme almaya başlayın.
                                </p>
                                <div class="slide-bottom d-md-flex align-items-center">
                                    <a href="#" class="slide-btn mb-xl-0 mb-3">
                    ...
                    <div class="swiper-slide">
                        <div class="row g-0 align-items-center">
                            <div class="col-xl-5 col-12">
                                <div class="slide-span mb-4">SANAL POS İLE ÖDEME ALMANI KOLAYLAŞTIR</div>
                                <h1 class="slide-title mb-4">
                                    Açık ve hazır altyapılar <br> ile güvenli ödeme alın
                                </h1>
                                <p class="slide-text mb-4">
                                    Paybull’un Wordpress, Opencart, Joomla, Magento ve Prestashop eklentileri ile
                                    güvenli bir şekilde ödeme almaya başlayın.

                                </p>
                                <div class="slide-bottom d-md-flex align-items-center">
                                    <a href="#" class="slide-btn mb-xl-3 mb-3">
                                        <span>Hızlı Entegrasyonlar</span>
                                        <img src="{{asset('assets')}}/frontEnd/img/top-right-arrow.svg" alt="">
                                    </a>
                                    <div>
                                        Üstelik ‘ertesi gün ödeme alma’ avantajı <br> ve 12 aya kadar taksit
