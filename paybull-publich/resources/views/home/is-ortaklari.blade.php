...
@section('title','İş Ortakları- PayBull')
@section('description', '')
@section('canonical','https://paybull.com/is-ortaklari') 
@section('content')
<main>
    <section class="py-20">
      <div class="container mx-auto px-4">
        <h2 class="mb-3 text-lg text-center section-semi-title">ANLAŞMALI BANKALAR</h2>
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/isbank.jpg" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/kuveytturk-bankasi.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/ptt-bankasi.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
          ...
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/teb-bank.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/yapikredi-bank.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/banks/ziraat-bankasi.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
    ...
    <section class="py-15">
      <div class="container mx-auto px-4">
        <h2 class="mb-3 text-lg text-center font-bold section-semi-title">PROGRAM ORTAKLARI</h2>
        <div class="flex flex-wrap -mx-4">
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
          ...
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/card/americanexpress.png" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
          ...
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/card/paraf.jpg" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/card/saglamkart.jpg" alt="">
            </div>
          </div>
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
    ...
    <section class="py-20">
      <div class="container mx-auto px-4">
        <h2 class="mb-3 text-lg text-center font-bold  section-semi-title ">İŞ ORTAKLARI</h2>
        <div class="flex flex-wrap -mx-4 justify-between">
          ...
          <div class="w-full mb-3 sm:w-1/2 md:w-1/3 lg:w-1/6 px-4">
            <div class="py-12 px-2 rounded-md shadow-xl">
              <img class="mx-auto h-6" src="{{asset('assets')}}/frontEnd/img/companies/magento-tr.png" alt="">
            </div>
          </div>
        </div>
      </div>
