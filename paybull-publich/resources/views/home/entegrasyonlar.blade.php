...
@section('title','Entegrasyonları Keşfedin – PayBull')
@section('description', 'PayBull’un WordPress, OpenCart, Joomla, Magento ve PrestaShop eklentileri ile güvenli bir şekilde ödeme almaya başlayabilirsiniz!')
@section('canonical','https://paybull.com/entegrasyonlar') 
@section('content')
<main>
    <section class="discover">
        <div class="container pt-20">
            <div class="section-span text-center">PAYBULL ENTEGRASYONLAR DÜNYASI</div>
            <h2 class="section-title text-center">
               Entegrasyonları Keşfedin!
            </h2>
            <p class="section-text text-center">
                Dünyanın her yerinden kolayca ödeme alacağınız ve taksitli satış yapabileceğiniz PayBull ile tanışın! Siz işlerinize odaklanırken ödemelerinizi PayBull’a bırakın.
            </p>
