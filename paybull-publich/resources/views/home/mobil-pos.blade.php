...
@section('title','Akıllı Telefonlarınız Artık Birer POS Cihazı – PayBull')
@section('description', ' Saha satışlarında ödeme almanın en kolay yolu olan PayBull Mobil POS’u kullanmak için yapmanız
                    gereken tek şey; PayBull mobil uygulamasını telefonunuza indirmek.')
@section('canonical','https://paybull.com/mobil-pos') 
@section('content')
<main>
    ...
    <section class="lg:py-5 md:py-32 overflow-x-hidden container">
        ...
        <div class="col-md-6 col-12 d-md-none">
             <div class="abouts-img">
                <img src="{{asset('assets')}}/frontEnd/img/general/mobil-pos.webp" alt="" />
          </div>
            
        </div>
       
        <div class="lg:pt-40 md:pt-15 text-left w-full flex flex-row lg:px-4">

            <div class="flex justify-center flex-col items-center md:items-start  w-full lg:pr-5">
                <h5 class="section-span text-center sm:text-left">PAYBULL MOBİL POS </h5>
                <h2 class="section-title text-left  ">
                    Akıllı Telefonlarınız Artık Birer
                    POS Cihazı!
                </h2>
                <p class="text-lg font-thin leading-10 text-left  ">
                    Saha satışlarında ödeme almanın en kolay yolu olan PayBull Mobil POS’u kullanmak için yapmanız
                ...
                <a href="{{route('hizli-basvuru')}}" class="why-btn about-btn mb-xl-4 mb-0 mt-8">
                    <div class="flex flex-row">
                        ...
                        <img class="ps-2" src="{{asset('assets')}}/frontEnd/img/document-text2.svg" alt="PayBull Hemen Başvuru Yap">
                    </div>
                </a>
            </div>
    ...
    <section class="py-5 md:py-32 overflow-x-hidden container">
         ...
         <div class=" col-md-6 col-12 d-md-none">
             <div class="abouts-img">
                <img src="{{asset('assets')}}/frontEnd/img/general/mobil-pos-xl.jpg" alt="" />
          </div>
            
        </div>
      <div class="text-left w-full flex flex-row lg:px-4 lg:pb-12">
          
        <div class="abouts-img hidden lg:block w-full h-full  lg:pr-5">
            
          <img src="{{asset('assets')}}/frontEnd/img/general/mobil-pos-2.webp" alt="" />
        </div>
        
        <div class="flex justify-center flex-col items-center md:items-start  w-full pr-2">
          ...
          <div class="row py-10">
            <div class="col-md-6 col-12">
              <div class="linkBox flex justify-center items-center flex-col sm:items-start px-2">
                <div class="linkBox__icon">
                  <img src="{{asset('assets')}}/frontEnd/img/icons/guvenli-ve-hizli.png" alt="Güvenli ve Hızlı Kurulum" width="48" height="48" />
                </div>
            ...
            <div class="col-md-6 col-12">
              <div class="linkBox flex justify-center items-center flex-col sm:items-start px-2">
                <div class="linkBox__icon">
                  <img src="{{asset('assets')}}/frontEnd/img/icons/taksitli-satis-imkani.svg" alt="Taksitli Satış İmkanı" />
                </div>
            ...
            <div class="col-md-6 col-12">
              <div class="linkBox flex justify-center items-center flex-col sm:items-start px-2">
                <div class="linkBox__icon">
                  <img src="{{asset('assets')}}/frontEnd/img/icons/ertesi-gun-odeme.svg" alt="Ertesi Gün Ödeme Alma" />
                </div>
            ...
            <div class="col-md-6 col-12">
              <div class="linkBox flex justify-center items-center flex-col sm:items-start">
                <div class="linkBox__icon">
                  <img src="{{asset('assets')}}/frontEnd/img/icons/24-saat.svg" alt="24 Saat İçinde Online Satış" />
                </div>
